...
The accelerometer continuously measures movement on the X, Y, and Z axes.

Arduino reads the analog signals from the sensor.

When the movement exceeds a predefined threshold:

The buzzer activates

The LEDs turn on

This indicates a potential theft or unauthorized movement.
